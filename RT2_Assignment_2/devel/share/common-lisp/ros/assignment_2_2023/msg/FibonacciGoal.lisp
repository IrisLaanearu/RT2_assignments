...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2_2023-msg:<FibonacciGoal> is deprecated: use assignment_2_2023-msg:FibonacciGoal instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <FibonacciGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2023-msg:order-val is deprecated.  Use assignment_2_2023-msg:order instead.")
  (order m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciGoal>)))
  ...
  "assignment_2_2023/FibonacciGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciGoal)))
  "Returns string type for a message object of type 'FibonacciGoal"
  "assignment_2_2023/FibonacciGoal")
